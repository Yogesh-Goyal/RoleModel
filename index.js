         ...
         if(result.length === 0){
           ...
           connection.query(query2,(err,result)=>{
              ...
              if(result.length === 0){
                ...
                const query3 = "select role_feature.feature from role_feature inner join user_role_per on role_feature.roleType = user_role_per.roleType  inner join user_per on user_per.per = user_role_per.per where user_per.user_id = "  + mysql.escape(userId) + " and user_role_per.per =" + mysql.escape(req.params.id) + "and user_role_per.user_id = user_per.user_id order by role_feature.feature" ; 
